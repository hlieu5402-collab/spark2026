...
fn load_state(path: &PathBuf) -> Result<BTreeMap<ConfigKey, ConfigValue>, io::Error> {
...
fn write_state(path: &PathBuf, state: &BTreeMap<ConfigKey, ConfigValue>) -> Result<(), io::Error> {
